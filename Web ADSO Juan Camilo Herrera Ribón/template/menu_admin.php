    ...
    <aside class="sidebar">
        <ul class="sidebar_list">
            ...
            <li class="sidebar_element">
                ...
                <div class="sidebar_hide">
                    <a class="sidebar_text" href="">Cuentas</a>
                </div>
            ...
            <li class="sidebar_element">
                ...
                <div class="sidebar_hide">
                    <a class="sidebar_text" href="">Inventario</a>
                </div>
            ...
            <li class="sidebar_element">
                ...
                <div class="sidebar_hide">
                    <a class="sidebar_text" href="">Mov. Ingreso</a>
                </div>
            ...
            <li class="sidebar_element">
                ...
                <div class="sidebar_hide">
                    <a class="sidebar_text" href="">Vista Ingreso</a>
                </div>
            ...
            <li class="sidebar_element">
                ...
                <div class="sidebar_hide">
                    <a class="sidebar_text" href="">Mov. Egreso</a>
                </div>
            ...
            <li class="sidebar_element">
                ...
                <div class="sidebar_hide">
                    <a class="sidebar_text" href="">Vista Egreso</a>
                </div>
            ...
            <li class="sidebar_element">
                ...
                <div class="sidebar_hide">
                    <a class="sidebar_text" href="">Cierre caja</a>
                </div>
